...
<data>
{
  for $v in tokenize($body/com:CommunityUpdateProcessRequest/com:old_community/text(),";")
  return
  <value>
  <struct>
  <member>
...
<data>
{
  for $v in tokenize($body/com:CommunityUpdateProcessRequest/com:new_community/text(),";")
  return
  <value>
  <struct>
  <member>
